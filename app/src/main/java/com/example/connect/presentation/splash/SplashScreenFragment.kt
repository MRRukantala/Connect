...
import com.example.connect.presentation.login.data.model.DataUser
...
class SplashScreenFragment : Fragment() {
    ...
    fun loggedIn(): UserResponse {
        ...
        val sharedPreferencesResponse = com.example.connect.presentation.login.data.model.response(
