...
class PendidikanUserFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.rv.adapter = Adapter(
            com.example.connect.main.ui.menu.info_pendidikan.pendidikan.Adapter.OnClickListener {
                viewModel.displayNewsDetails(it)
            },

            com.example.connect.main.ui.menu.info_pendidikan.pendidikan.Adapter.OnClickEditListener{
                viewModel.displayNewsDetails(it)
            }
        )
